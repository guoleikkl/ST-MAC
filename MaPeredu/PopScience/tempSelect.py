...
def story(content,score,LLM):
    ...
    The article after the style transfer should be an English short essay, without obvious expressions such as "Part 1" and "Part 2". Just directly output the resulting article without special formatting characters. 
...
def popSci(key,index):
    ...
    collectionName = f"WebnlgPopScoreAgent_{index}"
    collections = db[collectionName]
    newCollectionName = f"WebnlgPopSCIAgent_{index}"
...
def main():
    ...
    configKeys = [
        "135972d35135484f912ae8ae676f9316.2GRu7GXNr69W414e",
        "667335832e554738aac6752cca1d6142.0OuCpR1LUc2P7nIF",
        "3069d05f49fe4908acd8f3a43033fbdf.VGwNJ2ZAI6hz59UW",
        "4e8dd007413f4b4c942e0330a7244650.eAfXMpmPd4qLMZxg",
        "d1d33981bdd948128e05da9a86ccfca1.AbjnYkr7cHblvnmj",
        "6bf61783d82b4fc18480312d0f980968.qogS1GI2epHjYhZ7"
    ]
